...
public class ApiRequests {
	...
	/**
	 * Metodo usado para hacer una peticion POST mandando el json por un
	 * parametro llamado json
	 * 
	 * @param url URL a la que realizar la peticion.
	...
	public String postRequestWithParams(String url, String json) throws IOException {
		RequestBody formBody = new FormEncodingBuilder().add("datos", json).build();
